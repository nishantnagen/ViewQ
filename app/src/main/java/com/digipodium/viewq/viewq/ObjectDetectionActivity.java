...
public class ObjectDetectionActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    private class LableDetectionTask extends AsyncTask<Object, Void, BatchAnnotateImagesResponse> {
        private final WeakReference<ObjectDetectionActivity> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(ObjectDetectionActivity activity, Vision.Images.Annotate annotate) {
        ...
        protected void onPostExecute(BatchAnnotateImagesResponse result) {
            ObjectDetectionActivity activity = mActivityWeakReference.get();
           ...
           /* String spk=labels.toString();
            ...
            try {
                String textToSpeak = buff.toString();

                tts.speak(textToSpeak, TextToSpeech.QUEUE_FLUSH, null);
            } catch (Exception e) {

            }
            LabelAdapter adapter = new LabelAdapter(ObjectDetectionActivity.this, R.layout.recycler_scan, labels);
    ...
    private void callCloudVision(final Bitmap bitmap) {
        ...
        try {
            AsyncTask<Object, Void, BatchAnnotateImagesResponse> labelDetectionTask = new LableDetectionTask(this, prepareAnnotationRequest(bitmap));
